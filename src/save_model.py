"""
Run this once after training your model in the notebook to export all artifacts the API needs. 
Make sure best_model.pt already exists.
"""
import os
import pickle
import pandas as pd
...
# Rebuild the ID mappings from the dataset 
...
movies_df = pd.read_csv('../ml-100k-dataset/u.item', sep='|', names=item_cols, encoding='latin-1')
...
model = TwoTowerModel(num_users, num_items, embedding_dim=64)
